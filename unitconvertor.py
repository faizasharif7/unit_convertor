...
st.markdown(
    ...
    .stApp {
        background: linear-gradient(135deg,rgb(109, 153, 247), #cfe2f3);
        padding: 30px;
        border-radius: 15px;
    ...
    .stButton>button{
        background: liner-gradient(45deg, #0b5294, #351c75);
        color: black;
        font-size: 18px;
        paddingL 10px 20px;
        border-radius: 10px;
...
st.markdown("<div class='footer'>Created By Faiza Sharif </div>", unsafe_allow_html=True)
